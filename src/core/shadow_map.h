...
struct ShadowMap
{
    ...
    void setup(const Vec3 &dir, const Vec3 &center,
               float extent = 5.f,
    ...
    // lightSpaceMVP = lightProj * lightView * model  (pass identity for world pos)
    bool inShadow(const Vec3 &worldPos) const
    {
        ...
        // Perspective divide (ortho w=1 always, but kept for generality)
